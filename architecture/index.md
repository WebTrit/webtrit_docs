...
<img width="1130" height="771" alt="image" src="https://github.com/user-attachments/assets/3c1440b3-6c38-4816-84a7-1cb777d6ab9b" />
...
- **Media handling**: Audio/video streams, codec conversion, network traversal (NAT/firewall)
...
**Push Notification Server (Gorush)**
- Coordinates iOS APNs and Android FCM notifications  
- Handles offline call notifications and messaging
...
![WebTrit Sequence Diagram](diagrams/WebTritSystem_Sequence.png)
...
![WebTrit Deployment Diagram](diagrams/WebTritSystem_Deployment.png)
